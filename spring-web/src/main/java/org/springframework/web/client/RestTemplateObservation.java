...
public enum RestTemplateObservation implements DocumentedObservation {
	...
	public enum Outcome {
		...
		Outcome() {
			this.keyValue = KeyValue.of(LowCardinalityKeyNames.OUTCOME.asString(), name());
		}
